// В приложении 2 приведен проект, в котором реализован проект с использованием двусвязного списка. На основе данного проекта разработать функции, которые предлагается
// создать в данном приложении.
