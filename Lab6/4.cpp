...
// Создать список, содержащий элементы целого типа. Найти сумму положительных двухзначных элементов или выдать сообщение, что таких элементов 
// нет. 
...
void menu(void)  //Вывод меню 
{
    ...
    cout << " 3 - Сумма положительных двухзначных элементов" << endl;
    cout << " 4 - Запись информации в файл" << endl;
    cout << " 5 - Чтение из файла" << endl;
    cout << " 6 - Выход" << endl;
}

void add(list*& p, int value) //Добавление числа value в список 
{
    list* newP = new list;
...
void sum(list* p)
{
    ...
    else
    {
        ...
        if (howmuch > 1) {
            cout << "Сумма положительных двухзначных элементов = " << howmuch << endl;
        }
        else cout << "Положительных двухзначных элементов нет и суммы тоже :)" << endl;
    }
}
